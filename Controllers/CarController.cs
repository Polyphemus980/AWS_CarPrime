...
public class CarController : ControllerBase
{
    ...
    public CarController(ApplicationDbContext context, ILogger<CarController> logger, ICustomerService customerService,IRentalService rentalService, CarPrimeService carPrimeService)
    {
        _context = context;
        _logger = logger;
